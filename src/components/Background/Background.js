      ...
      ? (content = (
          <div className='bgShort'>
            ...
            <p>
              ...
              <strong>
                {' '}
                BA in Economics and a certificate of Technology
                Entrepreneurship.
              </strong>{' '}
            ...
            <p>
              Found myself tinkering on sites and fell in love with front-end
              web development, mostly HTML, CSS and Javascript.
            </p>
            <p>
      ...
      : (content = (
          <div className='bgLong'>
            <p>
              ...
              organization. I declared myself a future "architect" in grade
              school and loved playing with blocks, legos, kinects and games. In
              high school I was interested in math and the sciences, winning the
              senior year "Math Award" (given to one male and one female student
              in the school) and passing two years of college level (AP)
            ...
            <p>
              ...
              plan/schedule every className of my 4 years of college before I
              had even stepped into my dorm. I became interested in
              bio-psychology and how the brain works, philosophy, and eventually
              graduated ahead of schedule with a{' '}
              <strong>
                BA in Economics and a certificate of Technology
                Entrepreneurship.
              </strong>
            ...
            <p>
              ...
              case-by-case situations upon project requirements. I am a
              life-long learner who's always interested in expanding my
              knowledge and taking on projects.
            </p>
          </div>
        ));
    return (
      <section id='bg-content'>
        <div className='bgHeader'>
          <div className='storyChanger' onClick={this.changeStoryVersion}>
            ...
            <span className='lengthTitle'>short story</span>
          </div>
